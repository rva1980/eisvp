...
class Page extends Pages
{
    ...
    /**
     * Get children pages for a specific parent page
     * order by date descendent and a limit os pages, default 10
     *
     *  <code>
     *      $pages = Page::lastChildrens('page');
     *      $pages = Page::lastChildrens('page', 17);
     *  </code>
     *
     * @param  string $parent Parent page
     * @return array
     */
    public static function lastChildrens($parent, $limit = 10)
    {
        return Pages::$pages->select('[parent="'.(string) $parent.'" and status="published"]', $limit, null, null, 'date', 'DESC');
    }
